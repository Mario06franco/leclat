  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (imagen) {
        ...
        const uploadResponse = await axios.post('http://localhost:5000/api/upload', formDataImg, {
          headers: {
      ...
      const response = await axios.post('http://localhost:5000/api/servicios', servicioData);
